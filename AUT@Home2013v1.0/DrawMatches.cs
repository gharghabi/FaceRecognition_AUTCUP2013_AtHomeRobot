...
namespace Grip
{
    public class DrawMatches
    {
      ...
      public static Image<Bgr, Byte> Draw(Image<Gray, Byte> modelImage, Image<Gray, byte> observedImage, out long matchTime, PointF[] MyPt)
      {
         ...
         {  //draw a rectangle along the projected model
            ...
            result.DrawPolyline(Array.ConvertAll<PointF, Point>(pts, Point.Round), true, new Bgr(Color.Red), 5);
             //// Center Of Matched Object
            MyPt[0] = new PointF(pts[0].X, pts[0].Y);
            MyPt[1] = new PointF(pts[1].X, pts[1].Y);
            MyPt[2] = new PointF(pts[2].X, pts[2].Y);
            MyPt[3] = new PointF(pts[3].X, pts[3].Y);
             ///
         }
         #endregion
